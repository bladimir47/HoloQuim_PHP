    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>Welcome to HoloQuim</h1>
                
                <p style="color: #000000; font: bold 250%;">HoloQuim Manager administrator, create and discover new things</p>
                <form action="verficador.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="container col-md-4">
                            <button class="btn btn-primary btn-xl page-scroll" id="datos" name="datos"  type="submit">Sign in</button>
                        </div>
                    </div >
                </form>
            </div>
